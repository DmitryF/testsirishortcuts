...
- (FREObject _Nullable)initFreSwiftWithCtx:(FREContext _Nonnull)ctx argc:(uint32_t)argc argv:(FREObject _Nullable * _Nonnull)argv SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
